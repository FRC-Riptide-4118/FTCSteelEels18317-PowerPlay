...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(14, 0, 0.5);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(10, 0, 0.25);
...
//        BNO055IMUUtil.remapZAxis(imu, AxisDirection.POS_X);
        ...
        rightRear = hardwareMap.get(DcMotorEx.class, "rear_right_wheel");
