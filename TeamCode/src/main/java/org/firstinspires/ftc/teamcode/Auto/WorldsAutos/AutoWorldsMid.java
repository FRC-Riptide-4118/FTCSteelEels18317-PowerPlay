...
public class AutoWorldsMid extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence sequenceMiddle = mecanumDrive.trajectorySequenceBuilder(FieldPoseConstants.LeftAutoConstants.startPose)
                .forward(55)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, alignment::score)
                .UNSTABLE_addTemporalMarkerOffset(0, arm::armToSCORE)
//                .UNSTABLE_addTemporalMarkerOffset(-2, intake::close)
//                .UNSTABLE_addTemporalMarkerOffset(0, intake::open)
                .setReversed(true)
                .splineTo(new Vector2d(FieldPoseConstants.LeftAutoConstants.MidJunction.getX()-1, FieldPoseConstants.LeftAutoConstants.MidJunction.getY()), FieldPoseConstants.LeftAutoConstants.MidJunction.getHeading())
                // PreLoad
                .UNSTABLE_addTemporalMarkerOffset(0.0, arm::armToDrop)
                ...
                // Cone 1
                .setReversed(false)
                .lineToLinearHeading(new Pose2d(FieldPoseConstants.LeftAutoConstants.stack.getX()-23, FieldPoseConstants.LeftAutoConstants.stack.getY(), FieldPoseConstants.LeftAutoConstants.stack.getHeading()))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.05, slides::slidesToMedium)
                .UNSTABLE_addTemporalMarkerOffset(0.05, arm::armToSCORE)
                .waitSeconds(0.25)
                ...
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(FieldPoseConstants.LeftAutoConstants.MidJunction.getX(), FieldPoseConstants.LeftAutoConstants.MidJunction.getY(), FieldPoseConstants.LeftAutoConstants.MidJunction.getHeading() + Math.PI))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.0, gripper::gripCone)
                .UNSTABLE_addTemporalMarkerOffset(0.0, alignment::down)
                .UNSTABLE_addTemporalMarkerOffset(0.05, intake::in)
                .UNSTABLE_addTemporalMarkerOffset(0.1, slides::slidesToMedium)
                .UNSTABLE_addTemporalMarkerOffset(0.1, arm::armToSCORE)
                .waitSeconds(0.1)
                .UNSTABLE_addTemporalMarkerOffset(0.5, wrist::toScoring)
                .UNSTABLE_addTemporalMarkerOffset(0.6, intake::off)
                .UNSTABLE_addTemporalMarkerOffset(1.2, alignment::score)
                ...
                // PARK PARK PARK
                .setReversed(false)
                .lineToLinearHeading(FieldPoseConstants.LeftAutoConstants.parkMiddle)
                .build();


        TrajectorySequence sequenceLeft = mecanumDrive.trajectorySequenceBuilder(FieldPoseConstants.LeftAutoConstants.startPose)
                .forward(55)
                .UNSTABLE_addTemporalMarkerOffset(-12, arm::armToMiddle)
                .UNSTABLE_addTemporalMarkerOffset(0, slides::slidesToMedium)
                .UNSTABLE_addTemporalMarkerOffset(0, wrist::toScoring)
...
//                .UNSTABLE_addTemporalMarkerOffset(0, intake::open)
                ...
                // PARK PARK PARK
                .setReversed(false)
                .lineToLinearHeading(FieldPoseConstants.LeftAutoConstants.parkLeft)
                .build();

        TrajectorySequence sequenceRight = mecanumDrive.trajectorySequenceBuilder(FieldPoseConstants.LeftAutoConstants.startPose)
                .forward(55)
                .UNSTABLE_addTemporalMarkerOffset(-12, arm::armToMiddle)
                .UNSTABLE_addTemporalMarkerOffset(0, slides::slidesToMedium)
                .UNSTABLE_addTemporalMarkerOffset(0, wrist::toScoring)
...
//                .UNSTABLE_addTemporalMarkerOffset(0, intake::open)
                ...
                // PARK PARK PARK
                .setReversed(false)
                .lineToLinearHeading(FieldPoseConstants.LeftAutoConstants.parkRight)
                .build();
