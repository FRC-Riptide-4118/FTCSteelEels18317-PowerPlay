...
public class Left_RRMidJunction extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence High_Junction = drive.trajectorySequenceBuilder(LeftAutoConstants.startPose)
                ...
                .setReversed(true)
                .splineTo(new Vector2d(LeftAutoConstants.MidJunction.getX(), LeftAutoConstants.MidJunction.getY()), LeftAutoConstants.MidJunction.getHeading())
                .UNSTABLE_addTemporalMarkerOffset(-0.9, arm::armToPreScore)
                .UNSTABLE_addTemporalMarkerOffset(0, slides::slidesDrop)
                .UNSTABLE_addTemporalMarkerOffset(0.3, gripper::releaseCone)
                .UNSTABLE_addTemporalMarkerOffset(0.6, slides::slidesUp)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.01, slides::slidesToMedium)
                .setReversed(true)
                .splineTo(new Vector2d(LeftAutoConstants.MidJunction.getX()+3.5, LeftAutoConstants.MidJunction.getY()+0.5), LeftAutoConstants.MidJunction.getHeading())
                .UNSTABLE_addTemporalMarkerOffset(-0.9, arm::armToPreScore)
                .UNSTABLE_addTemporalMarkerOffset(0, slides::slidesDrop)
                .UNSTABLE_addTemporalMarkerOffset(0.3, gripper::releaseCone)
                .UNSTABLE_addTemporalMarkerOffset(0.6, slides::slidesUp)
