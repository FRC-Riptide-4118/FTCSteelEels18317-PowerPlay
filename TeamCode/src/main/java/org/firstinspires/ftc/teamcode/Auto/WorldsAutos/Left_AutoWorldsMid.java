...
public class Left_AutoWorldsMid extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence sequenceLeft = mecanumDrive.trajectorySequenceBuilder(FieldPoseConstants.LeftAutoConstants.startPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(1.5, alignment::up)
                // PARK PARK PARK
                .setReversed(false)
        ...
        TrajectorySequence sequenceRight = mecanumDrive.trajectorySequenceBuilder(FieldPoseConstants.LeftAutoConstants.startPose)
                ...
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(FieldPoseConstants.LeftAutoConstants.MidJunction.getX(), FieldPoseConstants.LeftAutoConstants.MidJunction.getY(), FieldPoseConstants.LeftAutoConstants.MidJunction.getHeading() + Math.PI))
                .UNSTABLE_addTemporalMarkerOffset(0.2, alignment::down)
                .UNSTABLE_addTemporalMarkerOffset(0.2, gripper::releaseCone)
                .waitSeconds(1)
                .UNSTABLE_addTemporalMarkerOffset(0.0, arm::armToScore)
                .UNSTABLE_addTemporalMarkerOffset(0.5, slides::slidesUp)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.6, arm::armToStart)
                .UNSTABLE_addTemporalMarkerOffset(0.7, slides::slidesToGround)
                .UNSTABLE_addTemporalMarkerOffset(1.0, alignment::up)
                // PARK PARK PARK
                .setReversed(false)
        ...
        TrajectorySequence sequenceMiddle = mecanumDrive.trajectorySequenceBuilder(FieldPoseConstants.LeftAutoConstants.startPose)
                ...
                .lineToLinearHeading(new Pose2d(FieldPoseConstants.LeftAutoConstants.stack.getX()-23, FieldPoseConstants.LeftAutoConstants.stack.getY(), FieldPoseConstants.LeftAutoConstants.stack.getHeading()))
                .forward(inchesToStack)
                .UNSTABLE_addTemporalMarkerOffset(-0.1, intake::close)
                .UNSTABLE_addTemporalMarkerOffset(-0.5, intake::in)
                .UNSTABLE_addTemporalMarkerOffset(0.0, gripper::gripCone)
                .UNSTABLE_addTemporalMarkerOffset(0.0, alignment::down)
                .UNSTABLE_addTemporalMarkerOffset(0.25, intake::open)
                .UNSTABLE_addTemporalMarkerOffset(slidesArmDelay, slides::slidesToMedium)
                .UNSTABLE_addTemporalMarkerOffset(slidesArmDelay, arm::armToPreScore)
                .waitSeconds(wristIntakeArmDelay)
                .UNSTABLE_addTemporalMarkerOffset(0.5, wrist::toScoring)
