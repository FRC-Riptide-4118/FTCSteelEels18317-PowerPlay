...
//            getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV));
     ...
     * empirically tuned.
     */
    public static double kV = 0.021739130434783;       // reaches target velocity
    public static double kA = 0.004;        // changes the slope
    public static double kStatic = 0.003;   // this is the last step
