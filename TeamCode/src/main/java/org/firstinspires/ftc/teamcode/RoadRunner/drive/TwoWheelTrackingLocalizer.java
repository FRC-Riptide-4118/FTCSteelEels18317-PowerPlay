...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -4.329; // X is the up and down direction
    public static double PARALLEL_Y = 4.003; // Y is the strafe direction

    public static double PERPENDICULAR_X = -5.847;
    public static double PERPENDICULAR_Y = -0.053;
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDrive drive) {
        ...
        parallelEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "front_left_wheel"));
